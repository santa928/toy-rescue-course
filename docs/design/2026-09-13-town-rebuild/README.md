...
状態: 2026-09-14 A純ボクセル案をユーザー承認。codex/town-model-rebuildで実装し、PR #6で最終検証。
...
公開準備: モデル/配置コード、比較画像、独立レビューをPR #6へ収録。既存の公開依頼に沿い、最終実走とCIが成功した版を同じGitHub Pagesへ反映する。依存・URL・保存形式は維持する。
