...
| 追加 | PHYS-001〜004、VIS-001、REG-003〜005 | 残るすり抜けと見た目上の誤認を一括解消し、observerとfixed-step schedulerの境界を物理契約へ含める | static構造物とruntime連動の炎を分け、破壊VFXの実挙動とobserver位相差を別の回帰契約で検証する。 |
